...
public class MainActivity extends Activity {
    ...
    private String flv_url = "http://chat.vdomax.com:8936/live/korrio.flv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String shareUrl = "https://www.vdomax.com/live/korrio?6677";
        ...
        fbLikeBtn = (FBLikeView) findViewById(R.id.fbLikeView2);
        ...
        btnPublish = (ToggleButton) findViewById(R.id.capture);
         preview = (SurfaceView) findViewById(R.id.camera_preview);

    }

    public void toggle(View v){
        if(btnPublish.isChecked()) {
            show_time.setVisibility(View.VISIBLE);
            Toast.makeText(getApplicationContext(), "the button is ON", Toast.LENGTH_SHORT).show();
            dispose();
